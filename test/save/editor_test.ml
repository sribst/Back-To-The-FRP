...
let text_t =
  let module M = struct
      ...
      let pp fmt (l,r) =
	Format.fprintf fmt "@[@<20>%s|@<20>%s@]" l r
    end
  in
...
let not_inline_time_order_list =
  [1;3;5;7;9]
...
let not_inline_time_same_order_list =
  [1;7;3;9;5]
...
let not_inline_time_no_order_list =
  [7;3;9;1;5]
...
let refine_fct  t v =
  Bttfrp.S.refine user (Bttfrp.T.of_int t) v

let observe_fct t  =
  Bttfrp.S.observe text (Bttfrp.T.of_int t) 
